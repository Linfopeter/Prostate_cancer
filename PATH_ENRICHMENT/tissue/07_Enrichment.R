...
dir_proyecto <- getwd()
dir_pbmcs <- file.path(dir_proyecto, "tissue1")
...
# Agrega esto justo después de crear datos_pathfindr
genes_para_analisis <- sum(datos_pathfindr$FDR_p < 0.05)
message(paste("Número de genes que pasan el filtro (padj < 0.05):", genes_para_analisis))
