...
# Definir las rutas base exactamente como las especificaste
dir_proyecto <- "."
...
dir.create(dir_align_out, showWarnings = FALSE)
dir.create(dir_counts_out, showWarnings = FALSE)
dir.create(dir_deseq_out, showWarnings = FALSE)
...
message("Iniciando el proceso de alineamiento...")
...
for (i in seq_along(archivos_1)) {
  ...
  align(
    ...
    maxFragLength = 600,
    PE_orientation = "fr",
    nthreads = 8, # Se mantiene tu valor original de 8 hilos
    keepReadOrder = FALSE,
