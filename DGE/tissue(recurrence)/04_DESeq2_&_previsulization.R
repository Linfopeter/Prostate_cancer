...
experimento$Condition <- factor(experimento$Condition, levels = c("Control", "Case"))
...
pca_lg2 <- plotPCA(dds_lg2, intgroup = "Condition", ntop = 500, returnData = TRUE)
print(ggplot(pca_lg2, aes(PC1, PC2, color=Condition)) +
        geom_point(size=3) +
