...
proportions_df <- deconvolution_results$proportions$svr_S0
...
#DIRECTORI ASIGNEMENT
dir.create("./tissue2/Resultados/granulator")
setwd("../")
setwd("./tissue2/Resultados/granulator")
