...
samples.to.be.excluded <- c("SRR057639.BAM")
...
CorLevelPlot(heatmap.data,
             x = names(heatmap.data)[22:23],  # Muestra los fenotipos (Healthy y Cancer)
             y = names(heatmap.data)[1:21],  # Muestra todos los módulos (del 1 al 22)
...
write.csv(gene.signf.Healthy, "./tissue1_Healthy_Assoc_genes_total.csv" , row.names = TRUE)
...
write.csv(gene.signf.Healthy_anno, "./tissue1_Healthy_Assoc_genes_anno.csv" , row.names = TRUE)
...
write.csv(gene.signf.Cancer, "./tissue1_Cancer_Assoc_genes_total.csv", row.names = TRUE)
...
write.csv(gene.signf.Cancer_anno, "./tissue1_Cancer_Assoc_genes_anno.csv" , row.names = TRUE)
